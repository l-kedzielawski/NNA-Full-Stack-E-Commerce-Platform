...
ARG NEXT_PUBLIC_MEDUSA_REGION_ID_EUR
ARG NEXT_PUBLIC_MEDUSA_REGION_ID_PLN
...
ENV NEXT_PUBLIC_MEDUSA_REGION_ID_EUR=$NEXT_PUBLIC_MEDUSA_REGION_ID_EUR
ENV NEXT_PUBLIC_MEDUSA_REGION_ID_PLN=$NEXT_PUBLIC_MEDUSA_REGION_ID_PLN
